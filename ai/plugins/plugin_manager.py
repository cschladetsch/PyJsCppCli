...
from .base import (
    BasePlugin, PluginError, PluginLoadError, PluginExecutionError,
    PluginType, PluginPriority, PluginMetadata,
    CommandPlugin, FilterPlugin, FormatterPlugin
)
...
class PluginManager:
    ...
    def _register_plugin_class(self, plugin_class: Type[BasePlugin], module_path: str) -> None:
        """
    ...
    def execute_command_plugin(self, command: str, args: List[str], context: Dict[str, Any]) -> Any:
        """
    ...
    def execute_filter_plugins(self, data: str, context: Dict[str, Any], filter_type: str) -> str:
        """
    ...
    def execute_formatter_plugin(self, response: str, format_name: str, context: Dict[str, Any]) -> str:
        """
