...
from ai.cli import handle_command_line_query, main


class TestCLI:
    """Test cases for CLI functionality"""
    
    @patch('ai.cli.ClaudeClient')
    @patch('ai.cli.save_conversation_state')
    @patch('ai.cli.load_conversation_state')
    ...
    def test_history_file_append(self, mock_file, mock_client_class):
        ...
        with patch('ai.cli.load_conversation_state', return_value=[]):
            with patch('ai.cli.save_conversation_state'):
    ...
    def test_main_help_flag(self):
        ...
        with patch('ai.cli.handle_command_line_query') as mock_handle:
